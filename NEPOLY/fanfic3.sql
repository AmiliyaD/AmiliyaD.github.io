...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 19 2021 г., 19:55
...
(35, 6, 50, 'Администратор', 'кквеуе', '2021-04-16 09:17:34', '2021-04-16 09:17:34'),
(36, 15, 59, 'Настоящий Мекрок', 'Где главы? ?', '2021-04-19 10:01:56', '2021-04-19 10:01:56');

-- --------------------------------------------------------

--
-- Структура таблицы `comment_pars`
--
...
--
-- Структура таблицы `history_pars`
--
...
(53, NULL, 6, 'Работа с новым жанром', 'Новый жанр', 'Завершен', NULL, 38, 7, '2021-04-15', 0),
(56, NULL, 6, 'впвпа', 'квпк', 'Завершен', NULL, 38, 0, '2021-04-15', 0),
(58, NULL, 15, 'не хочу учиться', 'не хочу учиться, а хочу жениться', 'В процессе', NULL, 3, 0, '2021-04-19', 0),
(59, NULL, 15, 'Лапша', 'Выросла большой, но так и осталась лапшой', 'В процессе', NULL, 4, 0, '2021-04-19', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `history_texts`
--
...
--
-- Дамп данных таблицы `history_texts`
--
...
INSERT INTO `users` (`id`, `roleName`, `name`, `login`, `email`, `email_verified_at`, `password`, `user_avatar`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'User', 'Амилия Жидкова', NULL, 'amiliaaya@gmail.com', NULL, '$2y$10$f//4syYWmv8gSBeZr05jZOw.RMSd/NcnvPrOmi1i7NALKjJB8xRte', NULL, NULL, '2020-10-23 08:21:57', '2020-10-23 08:21:57'),
(2, 'User', 'Жардемова Коркем', 'sdad', 'amilisaaya@gmail.com', NULL, '$2y$10$U51R23w5c3JAP7fmNGQL0uNiLhCS59rm99.g1HRftICVUUYNikQFC', NULL, NULL, '2020-10-23 08:22:55', '2020-10-23 08:22:55'),
(4, 'User', 'Андрей Шварков', 'asdsad', 'amiliya@gmail.com', NULL, '$2y$10$usp0w.dxZAJ5Z8670bFOcOIO4DDKzZ096xBUvQMGNaemJ7NAf60Yu', NULL, NULL, '2020-10-23 08:40:10', '2020-10-23 08:40:10'),
(5, 'User', 'Адлер Жидков', NULL, 'amiliyaaaaaaaa@mail.ru', NULL, '$2y$10$8UNuydhSYwRVi.TtEF.yTuVXiEFEFp38QDi5Tou081HdmW5q6imEq', NULL, NULL, '2021-02-27 02:00:46', '2021-02-27 02:00:46'),
(6, 'Admin', 'Администратор', 'Бесполое', 'demo1@worldskills.org', NULL, '$2y$10$jCmg7PdnuYC7jM4c21yhxOaR0Ma.wkfq9jk5onEqTw/cJDLRcEFsO', '', NULL, '2021-02-28 11:44:06', '2021-04-19 04:07:02'),
(7, 'User', 'Сергей Беликов', NULL, 'hyakovich0@va.gov', NULL, '$2y$10$yB37MMqlD0MxRcvYL1z8k.VQ6PU38v67omGg4Ww.rQp2472SqhNNm', 'sql1.PNG', NULL, '2021-02-28 11:48:08', '2021-04-17 10:32:38'),
(8, 'User', 'Алексей Минов', NULL, 'sadsd@mail.ru', NULL, '$2y$10$hoxrk5Wy2DkfeQB29n3nBuFuLvZR66F6rkE7PX1r39AcGwkShtPdu', NULL, NULL, '2021-02-28 11:51:58', '2021-02-28 11:51:58'),
(9, 'User', 'Саша Далецкая', 'fffffdfgfghgfdffff', 'amiliya@mail.ru', NULL, '$2y$10$a7oAppkmIn2QnCrxH1W.0uf3q3AF0kO1.FkG8uU8qq771hxWL93re', NULL, NULL, '2021-02-28 11:53:07', '2021-02-28 11:53:07'),
(11, 'User', 'Даша Малекацая', 'dfg', 'hyarrkovich0@va.gov', NULL, '$2y$10$Mup/YUpn7QxzLYjgqI5.ouxBdEVTFhhN679saBsodnDGc1bx2eM/u', NULL, NULL, '2021-03-01 01:46:14', '2021-03-01 01:46:14'),
(12, 'User', 'Карина Марикаов', 'amiliya', 'aaamiliya@mail.ru', NULL, '$2y$10$Blo/ldYolMIgVs7tIutNn.WCqLLxS1Kpa1wFtWtWJWvf7dzJ9mHo.', NULL, NULL, '2021-03-01 10:26:49', '2021-03-01 10:26:49'),
(13, 'User', 'Мекрок Мекроков', 'dfgdh', 'aaaaaaaaaaaaaa@mail.ru', NULL, '$2y$10$9CEldgD3LzpoEAHDZZFvRuupHLH6xiAZvk5euD8.1VITjB67so52G', NULL, NULL, '2021-03-01 10:41:35', '2021-03-01 10:41:35'),
(14, 'User', 'Mekrok Mekrokov', 'Mekrok', 'mekrooooook@gmail.com', NULL, '$2y$10$iANcpU5DTV37MALc8n/lUul4H12NimRqminZ35jBxUtdlAUReE63i', NULL, NULL, '2021-03-15 09:41:06', '2021-03-15 09:41:06'),
(15, 'User', 'Настоящий Мекрок', NULL, 'zhardemova2012@mail.ru', NULL, '$2y$10$475Jm12QafPaVd2eV09X0eP5ctcHiZuW8rb2aKzRPhDH/MMP1dSdW', 'Рисунок4.png', NULL, '2021-04-19 02:59:23', '2021-04-19 10:45:59');
...
--
-- AUTO_INCREMENT для таблицы `comment_pars`
--
ALTER TABLE `comment_pars`
...
--
-- AUTO_INCREMENT для таблицы `history_pars`
--
ALTER TABLE `history_pars`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;

--
-- AUTO_INCREMENT для таблицы `history_texts`
--
ALTER TABLE `history_texts`
...
--
-- Ограничения внешнего ключа таблицы `comment_pars`
--
ALTER TABLE `comment_pars`
...
--
-- Ограничения внешнего ключа таблицы `history_pars`
--
ALTER TABLE `history_pars`
...
--
-- Ограничения внешнего ключа таблицы `history_texts`
--
ALTER TABLE `history_texts`
  ADD CONSTRAINT `history_texts_ibfk_1` FOREIGN KEY (`history_id`) REFERENCES `history_pars` (`id`);

--
-- Ограничения внешнего ключа таблицы `profileimg`
--
ALTER TABLE `profileimg`
