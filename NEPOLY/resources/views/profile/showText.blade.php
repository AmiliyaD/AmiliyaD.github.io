...
<div class="container showText">
    ...
    <form action="{{ route('update') }}" method="post" class="  showText__body">
       @csrf
        <div class="row">
            <div class="col-md-5">
                <input type="text" name="par_title" value="{{$par->title}}" class="showText__title showBorder ">
            </div>
    ...
    <div class="row showText__pars">
        ...
        <div class="col-md-5 showText__parTitle">
            ...
            @endif
                ...
                <li>{{$text->id}} <a href="{{ route('editPar', ['ed_id'=>$text->history_id]) }}"> {{$text->history_title}} </a> </li>
                @endforeach
    ...
    <div class="row showText__buttons">
        ...
        <div class="col-md-5"><a href="{{ route('addParT', ['id'=>$par->id]) }}" class="allButtons">Добавить новую главу</a></div>
    </div>
</form>
